...
Jetson Orin Nano에서 ROS 2 노드로 패키징할 수 있도록 준비한 기어박스 정상/비정상 감지 모델과 추론 코드입니다.
...
- [`docs/VALIDATION.md`](docs/VALIDATION.md) — 2026-08-23 C270 마이크와 OpenCR LED 현장 검증 요약
- [`docs/ROS2_USAGE_LEGACY.md`](docs/ROS2_USAGE_LEGACY.md) — 당시 `~/ros2_ws` 환경의 상세 실행 기록
- [`../../scripts/component_demos/sound_anomaly/README.md`](../../scripts/component_demos/sound_anomaly/README.md) — 당시 단독 실행 스크립트 사용 기록
