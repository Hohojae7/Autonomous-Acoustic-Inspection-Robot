...
CONTROL_PACKAGE_ROOT = os.path.dirname(
    os.path.dirname(os.path.abspath(__file__)))
WORKSPACE_SRC = os.path.dirname(CONTROL_PACKAGE_ROOT)
sys.path.insert(0, CONTROL_PACKAGE_ROOT)
...
def _load_navigation_launch_module():
    path = os.path.join(
        WORKSPACE_SRC,
        "turtlebot3_inspection_bringup", "launch",
        "navigation_with_mux.launch.py")
